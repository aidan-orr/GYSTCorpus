...
public readonly record struct AnglicismContextKey(string Anglicism, int Year, int Category, string ContextWord)
{
	private const string separator = "||";
	public override string ToString() => $"{Anglicism}{separator}{Year}{separator}{Category}{separator}{ContextWord}";
